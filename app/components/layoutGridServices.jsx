...
export const LayoutGridServices = ({ cards }) => {
	const [selected, setSelected] = useState(null > null);
	const [lastSelected, setLastSelected] = useState(null > null);
	...
	return (
		<div className="w-full min-h-screen h-full p-10  grid grid-cols-1 md:grid-cols-3  max-w-7xl mx-auto gap-4 relative">
			{cards.map((card, i) => (
