...
export function SwiperSlider({ url, text, name }) {
	return (
		<div className="">
			...
			<div className="bg-black w-full lg:w-2/3 xl:w-1/2 lg:h-24 xl:h-32 absolute bottom-0 sm:flex flex-col text-center md:flex-row md:justify-center md:gap-[5rem] xl:gap-[10rem] py-2 md:py-10 lg:rounded-r-full font-cocomat">
				{" "}
